...
class LeafNode(RecordNode):
    ...
    def convert_to_lonelyRoot(self):
        lonelyRoot = LonelyRootNode(self._tree_conf, page=self.page)
        lonelyRoot.entries = self.entries
        return lonelyRoot
...
class InternalNode(ReferenceNode):
    ...
    def convert_to_root(self):
        rootNode = RootNode(self._tree_conf, page=self.page)
        rootNode.entries = self.entries
        return rootNode
